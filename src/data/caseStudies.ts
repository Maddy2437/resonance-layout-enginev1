...
export const caseStudies: CaseStudy[] = [
    {
        ...
        year: "2026",
        heroImage: "/assets/images/CaseStudies/Cover_Images/1.webp",
        thumbnail: "/assets/images/CaseStudies/Cover_Images/1.webp",
    ...
    },
    {
        ...
        year: "2025",
        heroImage: "/assets/images/CaseStudies/Cover_Images/2.webp",
        thumbnail: "/assets/images/CaseStudies/Cover_Images/2.webp",
    ...
    },
    {
        ...
        year: "2021- 2024",
        heroImage: "/assets/images/CaseStudies/Cover_Images/4.webp",
        thumbnail: "/assets/images/CaseStudies/Cover_Images/4.webp",
    ...
    },
    {
        ...
        year: "2024",
        heroImage: "/assets/images/CaseStudies/Cover_Images/6.webp",
        thumbnail: "/assets/images/CaseStudies/Cover_Images/6.webp",
    ...
    },
    {
        ...
        solution: "Developed product films and digital storytelling highlighting innovation and smart features.",
        ...
        sections: [
            { type: "image", image: caseStudyPath("Calamus", "1.png"), alt: "Calamus One e-bike hero visual", variant: "contained" },
            { type: "image", image: caseStudyPath("Calamus", "2.png"), alt: "Calamus One logo and identity system", variant: "contained" },
    ...
    },
    {
        ...
        service: "INTEGRATED MARKETING CAMPAIGN",
        year: "2024",
        heroImage: "/assets/images/CaseStudies/Cover_Images/10.webp",
        thumbnail: "/assets/images/CaseStudies/Cover_Images/10.webp",
        summary: "A brand campaign for Bangalore based Elegant Builders' new project, Atmos, which was centered around the five elements of nature i.e. water, air, electricity, environment and health in a luxurious setting. Right from the color palette, project logo to brand look, print ads, brochures, and all marketing communication collaterals across mediums.",
        ...
        creativeApproach: "Architectural visuals and nature-inspired layouts follow the PDF's layout sequence.",
        outcome: "Positioned the project at the intersection of sustainability and luxury.",
        sections: [
            { type: "image", image: caseStudyPath("MICL", "1.png"), alt: "Elegant project hero visual", variant: "contained" },
            { type: "gallery", variant: "two-column", images: [
                { src: caseStudyPath("MICL", "2.png"), alt: "Elegant project brand layout" },
                { src: caseStudyPath("MICL", "3.png"), alt: "Elegant lifestyle visual" }
            ] },
            { type: "image", image: caseStudyPath("MICL", "4.png"), alt: "Elegant project supporting visual", variant: "contained" }
        ],
        pdfClient: "ELEGANT BUILDERS & DEVELOPERS",
        pdfService: "INTEGRATED MARKETING CAMPAIGN",
        pdfYear: "2024",
        pdfDescription: "A brand campaign for Bangalore based Elegant Builders' new project, Atmos, which was centered around the five elements of nature i.e. water, air, electricity, environment and health in a luxurious setting. Right from the color palette, project logo to brand look, print ads, brochures, and all marketing communication collaterals across mediums."
    },
    {
        slug: "monte-carlo",
        title: "Monte Carlo",
        ...
        objective: "Position Monte Carlo SS'26 as the season's definitive summer fashion collection through a hybrid AI-led campaign.",
        challenge: "Create an innovative fashion visual campaign blending AI art with traditional photo shoots.",
        solution: "Crafted a visually compelling campaign blending AI-generated imagery with a hybrid production model, anchored by an extensive Malaysia shoot.",
        creativeApproach: "High-fashion visuals, AI-assisted rendering, and summer themes to evoke style and modernity.",
        outcome: "Delivered a scalable asset ecosystem deployed across all consumer touchpoints and media platforms.",
        sections: [
            { type: "image", image: caseStudyPath("Elegant", "1.png"), alt: "Monte Carlo project hero visual", variant: "contained" },
            { type: "gallery", variant: "two-column", images: [
                { src: caseStudyPath("Elegant", "2.png"), alt: "Monte Carlo project brand layout" },
                { src: caseStudyPath("Elegant", "3.png"), alt: "Monte Carlo lifestyle visual" }
            ] },
    ...
    },
    {
        ...
        year: "2026",
        heroImage: "/assets/images/CaseStudies/Cover_Images/12.webp",
        thumbnail: "/assets/images/CaseStudies/Cover_Images/12.webp",
